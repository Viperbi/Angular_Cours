...
export class OneFriendComponent {
  ...
  bio: string = "Dark Max existe et c'est déjà bien.";
  ...
  oneFriendStyle: string = '';
  listFriendTab: { tabName: string; tabAge: number; tabEmail: string }[] = [
    { tabName: 'Alice', tabAge: 30, tabEmail: 'alice@example.com' },
    { tabName: 'Bob', tabAge: 25, tabEmail: 'bob@example.com' },
    { tabName: 'Charlie', tabAge: 35, tabEmail: 'charlie@example.com' },
  ];
